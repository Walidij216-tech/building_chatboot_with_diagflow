CREATE DATABASE  IF NOT EXISTS `texas-food-restaurant` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `texas-food-restaurant`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: texas-food-restaurant
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Pizza',12.000),(2,'Tunisian Couscous',9.200),(3,'Sandwitch',6.000),(4,'Lablebi',5.000),(5,'Spaguetti',7.400),(6,'Tunisian dish',8.500),(7,'Panini',7.500),(8,'Savory crepe',4.500),(9,'Tacos',8.500),(10,'Apla can',3.000),(11,'Boga can',3.000),(12,'Orange juice',5.000),(13,'Strawberry juice',5.500),(14,'Banana juice',6.000);
...
INSERT INTO `orders` VALUES (40,1,2,24.000),(40,3,1,6.000),(41,4,3,15.000),(41,6,2,17.000),(41,9,4,34.000);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `get_price_for_item`(p_item_name VARCHAR(255)) RETURNS decimal(10,3)
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `get_total_order_price`(p_order_id INT) RETURNS decimal(10,3)
    DETERMINISTIC
BEGIN
    DECLARE v_total_price DECIMAL(10, 3);
